...
//    gamestartBtn->addTouchEventListener(CC_CALLBACK_2(WarScenceLayer::touchEvent, this));
//    
//    auto gameSetBtn = dynamic_cast<Button*>(rootNode->getChildByName("gameSet_Button"));
//    gameSetBtn->addTouchEventListener(CC_CALLBACK_2(WarScenceLayer::touchEvent, this));
//    
//    auto mailBtn = dynamic_cast<Button*>(rootNode->getChildByName("mail_Button"));
//    mailBtn->addTouchEventListener(CC_CALLBACK_2(WarScenceLayer::touchEvent, this));
//    
//    auto shopBtn = dynamic_cast<Button*>(rootNode->getChildByName("shop_Button"));
//    shopBtn->addTouchEventListener(CC_CALLBACK_2(WarScenceLayer::touchEvent, this));
//    
//    auto gameCenterBtn = dynamic_cast<Button*>(rootNode->getChildByName("gameCenter_Button"));
//    gameCenterBtn->addTouchEventListener(CC_CALLBACK_2(WarScenceLayer::touchEvent, this));
//    
//    auto paihangbangBtn = dynamic_cast<Button*>(rootNode->getChildByName("paiHangBang_Button"));
//    paihangbangBtn->addTouchEventListener(CC_CALLBACK_2(WarScenceLayer::touchEvent, this));
//    
    
    return true;
}
void WarScenceLayer::touchEvent(cocos2d::Ref *pSender, Widget::TouchEventType type)
{
    //字符串作为case
...
void WarScenceLayer::menuTouchCallback(Ref* pSender)
{
